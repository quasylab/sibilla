...
/**
 * Implements a visitor that, by inspecting the content of a parse tree, returns a boolean value if
 * no error is found.
 */
public abstract class LIOModelParseTreeChecker extends LIOModelBaseVisitor<Boolean> {
     ...
     */
    public LIOModelParseTreeChecker(ErrorCollector errors) {
        this.errors = errors;
    }
