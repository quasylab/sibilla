...
public class PopulationPredicateChecker extends BooleanExpressionChecker {

    public PopulationPredicateChecker(List<ModelBuildingError> errorList, PopulationExpressionChecker numberExpressionChecker) {
        super(errorList, numberExpressionChecker);
    }
