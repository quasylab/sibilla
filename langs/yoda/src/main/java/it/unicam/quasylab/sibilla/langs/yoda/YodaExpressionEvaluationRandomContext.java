...
public class YodaExpressionEvaluationRandomContext implements YodaExpressionEvaluationContext {
    private final RandomGenerator rg;

    public YodaExpressionEvaluationRandomContext(RandomGenerator rg) {
        this.rg = rg;
    }
