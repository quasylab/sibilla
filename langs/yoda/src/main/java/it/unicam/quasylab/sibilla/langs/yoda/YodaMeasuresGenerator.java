...
public class YodaMeasuresGenerator extends YodaModelBaseVisitor<Boolean> {
    ...
    public YodaMeasuresGenerator(Function<String, Optional<SibillaValue>> constantsAndParameters, YodaVariableRegistry variableRegistry, YodaElementNameRegistry registry) {
    ...
    public Boolean visitMeasureDeclaration(YodaModelParser.MeasureDeclarationContext ctx) {
        ...
        measures.put(ctx.name.getText(), sys -> measureFunction.apply(sys).doubleOf());
        return true;
    }
