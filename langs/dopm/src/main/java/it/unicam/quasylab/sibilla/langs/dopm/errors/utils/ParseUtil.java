...
public class ParseUtil {
    ...
    public static String illegalUseOfName(String name, DataOrientedPopulationModelParser.ReferenceExpressionContext ctx) {
        return String.format(ILLEGAL_USE_OF_NAME_MESSAGE,name,ctx.start.getLine(),ctx.start.getCharPositionInLine());
    }

    public static String illegalUseOfName(String name, DataOrientedPopulationModelParser.SenderReferenceExpressionContext ctx) {
        return String.format(ILLEGAL_USE_OF_NAME_MESSAGE,name,ctx.start.getLine(),ctx.start.getCharPositionInLine());
    }
}
