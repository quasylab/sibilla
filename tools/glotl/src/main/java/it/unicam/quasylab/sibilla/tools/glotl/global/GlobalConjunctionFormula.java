...
public class GlobalConjunctionFormula<T, S extends IndexedState<T>> implements GlobalFormula<T, S> {

    private final GlobalFormula<T, S> firstArgument;
    private final GlobalFormula<T, S> secondArgument;

    public GlobalConjunctionFormula(GlobalFormula<T, S> firstArgument, GlobalFormula<T, S> secondArgument) {
    ...
    public GlobalFormula<T,S> next(S state) {
        ...
        return GlobalFormula.conjunction(firstNext, secondNext);
    }
    ...
    public boolean equals(Object o) {
        ...
        GlobalConjunctionFormula<?, ?> that = (GlobalConjunctionFormula<?, ?>) o;
