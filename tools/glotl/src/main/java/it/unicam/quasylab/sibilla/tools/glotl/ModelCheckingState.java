...
public interface ModelCheckingState<T, S extends IndexedState<T>> {

    ProbabilityVector<ModelCheckingState<T, S>> next(Function<S, ProbabilityVector<S>> stepFunction);
