...
public class PopulationModelDefinition extends AbstractModelDefinition<PopulationState> {
    ...
    @Override
    public Function<RandomGenerator, PopulationState> getConfiguration(String name, double ... args) {
    ...
    @Override
    public Function<RandomGenerator,PopulationState> getDefaultConfiguration(double... args) {
