...
/**
 * This functional interface is used to represent a random function that depends on a delta time and that
 * given a value of type <code>T</code> returns a value of type <code>R</code>.
 *
 * @param <T> type of function parameter
 */
@FunctionalInterface
public interface SibillaRandomTimedFunction<T, R> {
