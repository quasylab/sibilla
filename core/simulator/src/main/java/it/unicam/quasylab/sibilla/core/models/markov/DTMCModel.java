...
import it.unicam.quasylab.sibilla.core.models.DiscreteTimeMarkovProcess;
...
/**
 * This class is used to identify DTMCs.
 */
public class DTMCModel extends MarkovChainModel implements DiscreteTimeMarkovProcess<MappingState> {

    /**
     * Create a new DTMC whose states have the given variables and transition probability is induced by the given function.
     *
