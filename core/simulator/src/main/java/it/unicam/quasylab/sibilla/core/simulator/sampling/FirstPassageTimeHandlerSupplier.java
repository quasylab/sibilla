...
public class FirstPassageTimeHandlerSupplier<S extends State> implements Supplier<SamplingHandler<S>> {
    ...
    public FirstPassageTimeHandlerSupplier(String name, Predicate<? super S> condition) {
        this.name = name;
        this.condition = condition;
        this.values = new DescriptiveStatistics();
    }

    public synchronized FirstPassageTime getResults() {
        return new FirstPassageTime(tests, values);
    }
