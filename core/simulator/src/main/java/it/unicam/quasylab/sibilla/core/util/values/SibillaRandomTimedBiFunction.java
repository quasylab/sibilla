...
/**
 * This functional interface is used to represent a random function that depends on a delta time and that, given two values of type <code>T</code> and <code>V</code>,
 ...
 */
@FunctionalInterface
public interface SibillaRandomTimedBiFunction<T, V, R> {
     ...
     */
    R eval(RandomGenerator rg, double dt, T t, V v);
