...
public class AgentPrototype {
     ...
     * @param prototypeId                   id associated with this prototype.
     */
    public AgentPrototype(String agentName, int prototypeId, SlamType[] parameters) {
    ...
    public Agent getAgent(int agentId,SlamValue[] values) {
        return new Agent(this.prototypeId,
                agentId,
     ...
     */
    public void setAgentBehaviour(AgentBehaviour agentBehaviour) {
