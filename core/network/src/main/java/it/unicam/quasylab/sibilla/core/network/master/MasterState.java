...
public class MasterState implements Serializable, Comparable<MasterState>, PropertyChangeListener, Cloneable {
    ...
    /**
     * Collection of the {@link NetworkInfo} associated with every slave server registered.
     */
    ...
    /**
     * Removes a {@link SimulationState}.
     *
     ...
     *
     * @param masterState the {@link MasterState} to be compared.
