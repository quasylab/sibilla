...
public interface TCPNetworkManager {
    ...
    /**
     * Factory method used to obtain {@link TCPNetworkManager} implementations' instances.
     ...
     * @return {@link TCPNetworkManager} that will manage the requested connection
     * @throws IOException
     */
     ...
     * Used in classes that want to initiate a network communication.
     *
     * @param networkType the type associated with the implementation of {@link TCPNetworkManager} that will be instantiated
    ...
    /**
     * @return a copy of the {@link NetworkInfo} instance associated with the manager.
     */
    ...
    /**
     * @return the {@link TCPNetworkManagerType} associated with the {@link TCPNetworkManager} implementation.
     */
