...
public class SimulationState implements Serializable, PropertyChangeListener, Comparable<SimulationState>, Cloneable {
     ...
     *
     * @param simulationState the {@link SimulationState} to be compared.
     ...
     * @return {@link SlaveState} associated with the slave, null if the slave requested was not present.
     */
    ...
    /**
     * @return a deep clone of the {@link SimulationState} in which is called.
     */
    @Override
