...
public interface UDPNetworkManager {
     ...
     * @return {@link UDPNetworkManager} that will manage the requested connection
     ...
     * Used in classes that want to initiate a network communication.
     *
     * @param networkType    the type associated with the implementation of {@link UDPNetworkManager} that will be instantiated
