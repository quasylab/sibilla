...
public class OptimizationStlFormulaExample {
    ...
    private static class SirExample extends Example{
        ...
        private Trajectory<PopulationState> getTrajectory (){
            ...
            trajectorySampled.setEnd(this.formula.getTimeHorizon());
            return trajectorySampled;
        }
    ...
    @Disabled
    @Test
    public void testSirRobustness() throws StlModelGenerationException, ModelGenerationException, IOException {
