...
/**
 * This kind of rule is used to describe a one-to-many interaction. An element of
 * the population is sending a message that can be received, with a given probabilities,
 * by a group of elements of other species.
 */
