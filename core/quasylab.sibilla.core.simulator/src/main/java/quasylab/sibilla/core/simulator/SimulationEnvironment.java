...
public class SimulationEnvironment implements Serializable {
	...
	public synchronized <S extends State> void simulate(RandomGenerator random, MarkovProcess<S> model, S initialState,
	...
	public synchronized <S extends State> void simulate(SimulationMonitor monitor, RandomGenerator random, MarkovProcess<S> model,
		...
		SimulationUnit<S> unit = new SimulationUnit<>(model, initialState,
	...
	public <S extends State> double reachability(SimulationMonitor monitor, RandomGenerator random, MarkovProcess<S> model, S state,
