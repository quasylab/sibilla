...
public class SimulationDataSet<S> implements Serializable {
	...
	public void setModelReference(Model<S> modelReference) {
	...
	public void setModelReferenceInitialState(S modelReferenceInitialState) {
		this.modelReferenceInitialState = modelReferenceInitialState;
	}
	...
	public void setModelReferenceSamplingFunction(SamplingFunction<S> modelReferenceSamplingFunction) {
		this.modelReferenceSamplingFunction = modelReferenceSamplingFunction;
	}
