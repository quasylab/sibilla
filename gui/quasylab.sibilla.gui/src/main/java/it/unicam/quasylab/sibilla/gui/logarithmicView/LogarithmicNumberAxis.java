...
public class LogarithmicNumberAxis extends ValueAxis<Number> {
    ...
    //Create our LogarithmicAxis class that extends ValueAxis<Number> and define two properties
    // that will represent the log lower and upper bounds of our axis.
