...
public class CovidDSModel {
    ...
    public final static double LAMBDA_MEET = 1.5;
...
//		StatisticSampling<PopulationModel> rSamp = StatisticSampling.measure("#R", SAMPLINGS, DEADLINE, s -> s.getCurrentState().getOccupancy(R)) ;
        ...
        faSamp.printTimeSeries(new PrintStream("data/covid_ds_A_.data"),';');
        fagSamp.printTimeSeries(new PrintStream("data/covid_ds_AG_.data"),';');
        fgSamp.printTimeSeries(new PrintStream("data/covid_ds_G_.data"),';');
        frSamp.printTimeSeries(new PrintStream("data/covid_ds_R_.data"),';');
        fsSamp.printTimeSeries(new PrintStream("data/covid_ds_S_.data"),';');
        fdSamp.printTimeSeries(new PrintStream("data/covid_ds_D_.data"),';');
        System.exit(0);
    }
