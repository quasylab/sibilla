...
public class MeshModelRefactored extends PopulationModelDefinition {
        ...
        public Model<PopulationState> createModel() {
                ...
                rules.add(new ReactionRule("M1->A" + 0 + 0,
                                new Population[] { new Population(r.indexOf("A", 0, 0)),
                                                new Population(r.indexOf("M1")) },
                                new Population[] { new Population(r.indexOf("AM", 0, 0)) }, (t, s) -> LAMBDA_S / H));

                rules.add(new ReactionRule("M2->A" + 0 + H,
                                new Population[] { new Population(r.indexOf("A", 0, H)),
                                                new Population(r.indexOf("M2")) },
                                new Population[] { new Population(r.indexOf("AM", 0, H)) }, (t, s) -> LAMBDA_S / H));
                ...
                for (int i = 0; i < N - 1; i++) {
                        ...
                        rules.add(new ReactionRule( // Spostamento avanti
                                        "A" + i + 0 + "->A" + k + 0,
                                        new Population[] { new Population(r.indexOf("AM", i, 0)),
                                                        new Population(r.indexOf("A", k, 0)) },
                                        new Population[] { new Population(r.indexOf("A", i, 0)),
                                                        new Population(r.indexOf("AM", k, 0)) },
                                        (t, s) -> LAMBDA_S / 3));

                        rules.add(new ReactionRule( // Spostamento sopra
                                        "A" + i + 0 + "->A" + i + 1,
                                        new Population[] { new Population(r.indexOf("AM", i, 0)),
                                                        new Population(r.indexOf("A", i, 1)) },
                                        new Population[] { new Population(r.indexOf("A", i, 0)),
                                                        new Population(r.indexOf("AM", i, 1)) },
                                        (t, s) -> LAMBDA_S / 3));

                        rules.add(new ReactionRule( // Spostamento diagonale sopra
                                        "A" + i + 0 + "->A" + k + 1,
                                        new Population[] { new Population(r.indexOf("AM", i, 0)),
                                                        new Population(r.indexOf("A", k, 1)) },
                                        new Population[] { new Population(r.indexOf("A", i, 0)),
                                                        new Population(r.indexOf("AM", k, 1)) },
                                        (t, s) -> LAMBDA_S / 3));
                        ...
                        rules.add(new ReactionRule( // Spostamento avanti
                                        "A" + i + q + "->A" + k + q,
                                        new Population[] { new Population(r.indexOf("AM", i, q)),
                                                        new Population(r.indexOf("A", k, q)) },
                                        new Population[] { new Population(r.indexOf("A", i, q)),
                                                        new Population(r.indexOf("AM", k, q)) },
                                        (t, s) -> LAMBDA_S / 3));

                        rules.add(new ReactionRule( // Spostamento sotto
                                        "A" + i + q + "->A" + i + w,
                                        new Population[] { new Population(r.indexOf("AM", i, q)),
                                                        new Population(r.indexOf("A", i, w)) },
                                        new Population[] { new Population(r.indexOf("A", i, q)),
                                                        new Population(r.indexOf("AM", i, w)) },
                                        (t, s) -> LAMBDA_S / 3));

                        rules.add(new ReactionRule( // Spostamento diagonale sotto
                                        "A" + i + q + "->A" + k + w,
                                        new Population[] { new Population(r.indexOf("AM", i, q)),
                                                        new Population(r.indexOf("A", k, w)) },
                                        new Population[] { new Population(r.indexOf("A", i, q)),
                                                        new Population(r.indexOf("AM", k, w)) },
                                        (t, s) -> LAMBDA_S / 3));
                        ...
                        for (int j = 1; j < H - 1; j++) {
                                ...
                                rules.add(new ReactionRule( // Spostamento avanti
                                                ...
                                                new Population[] { new Population(r.indexOf("AM", i, j)),
                                                                new Population(r.indexOf("A", k, j)) },
                                                new Population[] { new Population(r.indexOf("A", i, j)),
                                                                new Population(r.indexOf("AM", k, j)) },
                                                (t, s) -> LAMBDA_S / 5));
                                ...
                                rules.add(new ReactionRule( // Spostamento sopra
                                                "A" + i + j + "->A" + i + q,
                                                new Population[] { new Population(r.indexOf("AM", i, j)),
                                                                new Population(r.indexOf("A", i, q)) },
                                                new Population[] { new Population(r.indexOf("A", i, j)),
                                                                new Population(r.indexOf("AM", i, q)) },
                                                (t, s) -> LAMBDA_S / 5));
                ...
                for (int j = 1; j < H - 1; j++) {
                        ...
                        rules.add(new ReactionRule( // arrivo a destinazione
                                        "A" + i + j + "->D", new Population[] { new Population(r.indexOf("AM", i, j)) },
                                        new Population[] { new Population(r.indexOf("A", i, j)) },
                                        (t, s) -> LAMBDA_S * (1 - P_F)));
                ...
                rules.add(new ReactionRule("A" + z + 0 + "->D",
                                new Population[] { new Population(r.indexOf("AM", z, 0)) },
                                new Population[] { new Population(r.indexOf("A", z, 0)) },
                                (t, s) -> LAMBDA_S * (1 - P_F)));

                rules.add(new ReactionRule("A" + z + 0 + "->A" + z + 1,
                                new Population[] { new Population(r.indexOf("AM", z, 0)),
                                                new Population(r.indexOf("A", z, 1)) },
                                new Population[] { new Population(r.indexOf("A", z, 0)),
                                                new Population(r.indexOf("AM", z, 1)) },
                                (t, s) -> LAMBDA_S * P_F));

                rules.add(new ReactionRule("A" + z + x + "->D",
                                new Population[] { new Population(r.indexOf("AM", z, x)) },
                                new Population[] { new Population(r.indexOf("A", z, x)) },
                                (t, s) -> LAMBDA_S * (1 - P_F)));

                rules.add(new ReactionRule("A" + z + x + "->A" + z + c,
                                new Population[] { new Population(r.indexOf("AM", z, x)),
                                                new Population(r.indexOf("A", z, c)) },
                                new Population[] { new Population(r.indexOf("A", z, x)),
                                                new Population(r.indexOf("AM", z, c)) },
                                (t, s) -> LAMBDA_S * P_F));

                PopulationModel pModel = new PopulationModel(r.size(), this);
        ...
        public static List<StatisticSampling<PopulationState>> getSamplingList() {
                ...
                for (int i = 0; i < N; i++) {
                        for (int j = 0; j < H; j++) {
                                ...
                                int idx = i;
                                samplings.add(StatisticSampling.measure("AM" + i + j, SAMPLINGS, DEADLINE,
                                                s -> s.getOccupancy(r.indexOf("AM", idx, jdx))));
                        }
                }
                samplings.add(StatisticSampling.measure("MESSAGES", SAMPLINGS, DEADLINE,
